...
public class FavoriteFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.favorite_frament2, container, false);
        ...
        final String mycity = jsondata.getString("city");
        FloatingActionButton fab = rootView.findViewById(R.id.fab1);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(activity,  mycity + " was removed from favorites",
                        Toast.LENGTH_LONG).show();

                SharedPreferences mycities = activity.getSharedPreferences("favoriteCities",MODE_PRIVATE);
